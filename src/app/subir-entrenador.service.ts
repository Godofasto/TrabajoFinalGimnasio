...
export class SubirEntrenadorService {
  ...
  subirEntrenador(datos : any){
    return this.http.post('https://localhost:7104/api/entrenadores/SubirEntrenadores', datos);
  }
  recogerEntrenadores(dato: any){
    ...
    //   TipoDato : dato
    // }
    return this.http.post('https://localhost:7104/api/entrenadores/RetornarTodosEntrenadores', {});
  }
}
